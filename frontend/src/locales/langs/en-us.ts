const local: App.I18n.Schema = {
  ...
  page: {
    ...
    userPortrait: {
      ...
      noPortrait: "No portrait yet. Chat more with AI.",
      noExperience: "No experiences yet",
      edit: "Edit",
      delete: "Delete",
      extract: "Re-extract",
      extractSuccess: "Extraction triggered, {count} session(s) processed",
      extractionOn: "Auto extraction on",
      extractionOff: "Auto extraction off",
      edited: "Manually edited",
      updatedAt: "Updated at",
      editPortrait: "Edit Portrait",
      summary: "Summary",
      summaryPlaceholder: "Describe the user portrait in one paragraph",
      tags: "Tags",
    ...
    userProfile: {
      ...
      telegramBindCode: "Bind Code",
      telegramBindCodeHint: "Please send the following command to the bot on Telegram:",
      telegramBindCodeExpire: "Expires at",
      telegramGenerateCode: "Generate Bind Code",
      telegramUnbind: "Unbind",
      telegramUnbindConfirm: "Are you sure to unbind Telegram?",
      telegramUnbindSuccess: "Unbound successfully",
      telegramGenerateSuccess: "Bind code generated",
      telegramBotNotConfigured: "Telegram Bot not configured",
    },
    cut: {
      name: "Name",
      type: "Type",
